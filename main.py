"""The perfect game from the masters of their craft.
They are god-like, moon-faced and unsurpassed!.
"""
...
def attack(char_name: str, char_class: str) -> str:
    """Описываю функцию атаки, возвращаю урон."""
...
def defence(char_name: str, char_class: str) -> str:
    """Описываю функцию защиты, возвращаю блок."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Описываю функцию улты, возвращаю потрясающую штуковину."""
    if char_class == 'warrior':
        return (f'{char_name}'
...
def start_training(char_name: str, char_class: str) -> str:
    """Выбираю действиве, или заканциваю программу."""
    if char_class == 'warrior':
